...
#### Option A: Instructor-Provided Repository
If you're working on a class assignment, use the repository or setup link provided by your instructor. Course-specific repository creation may vary by semester.
...
- **`static/`** - Static assets (images, files) for your project
- **`src/pages/`** - Custom React pages (like the homepage)
- **`docusaurus.config.js`** - Small project configuration
- **`@tu-cis-project-docs/docusaurus`** - The reusable documentation runtime that provides this tutorial and shared components

## Next Steps

1. **Customize your project settings** in `docusaurus.config.js`
